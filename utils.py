    ...
    return {
        ...
        "template": {
            "outputs": [
                {
                    "basicCard": {
                        'title': f"무엇을 원하시는지 잘 모르겠어요.",
                        "description": f"원하시는 것을 좀 더 정확하게 \n말씀해주시면 더 좋을 것 같습니다!",
                        "thumbnail": {
                            "imageUrl": 'https://img.freepik.com/premium-vector/feeling-sorry-and-guilt-concept-young-sad-frustrated-woman-feeling-guilty-holding-sign-saying-sorry-in-hands-vector-illustration_160308-3557.jpg'
                        }
                    }
                }
            ]
